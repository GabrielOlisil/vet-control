...
{#if isOpen}
    ...
    >
        <div
            class="modal-box bg-base-100 text-base-content max-w-2xl shadow-2xl p-0 overflow-hidden"
        >
            <div
            ...
            >
                ...
                <div
                    class="px-6 py-4 bg-base-200/50 border-t border-base-200 flex justify-end gap-2"
                >
                    <button
                        type="button"
                        onclick={handleClose}
